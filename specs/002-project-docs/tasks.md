...
- [ ] T001 Create initial document skeletons with top-level headings in docs/user-guide.md, docs/developer-guide.md, docs/reviewer-guide.md, and docs/persistence-reference.md
...
- [ ] T007 [US1] Draft prerequisites, installation, launch, and desktop-browser support sections in docs/user-guide.md
...
- [ ] T017 [US3] Draft the numbered validation checklist with at most 12 top-level steps in docs/reviewer-guide.md
- [ ] T018 [P] [US3] Add copy-paste validation commands and expected outcomes in docs/reviewer-guide.md
- [ ] T019 [P] [US3] Add offline verification, Playwright install remedy, and failed-command exception workflow in docs/reviewer-guide.md
...
- [ ] T021 [US4] Draft the SQLite tables and schema-purpose reference in docs/persistence-reference.md
- [ ] T022 [P] [US4] Add localStorage keys, document shapes, and IndexedDB/SQLite lifecycle sections in docs/persistence-reference.md
- [ ] T023 [P] [US4] Add seed-data invariants, best-score protection rules, and persistence failure/recovery guidance in docs/persistence-reference.md
