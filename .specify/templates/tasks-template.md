...
**Tests**: Test tasks are REQUIRED whenever behavior changes. Each user story MUST include
the tasks needed to prove the story independently at the appropriate unit, integration,
contract, or end-to-end level.
...
- [ ] T004 [P] Configure automated test and quality check commands
...
- [ ] T011 Capture shared UX patterns, accessibility constraints, and performance budgets
...
- [ ] T014 [P] [US1] Unit test for [core behavior] in tests/unit/test_[name].py
...
- [ ] T020 [US1] Validate UX states and accessibility for the story flow
- [ ] T021 [US1] Verify performance budget for the story workflow
...
- [ ] T025 [P] [US2] Unit test for [core behavior] in tests/unit/test_[name].py
...
- [ ] T029 [US2] Validate UX states and accessibility for the story flow
- [ ] T030 [US2] Verify performance budget for the story workflow
...
- [ ] T034 [P] [US3] Unit test for [core behavior] in tests/unit/test_[name].py
...
- [ ] T038 [US3] Validate UX states and accessibility for the story flow
- [ ] T039 [US3] Verify performance budget for the story workflow
...
- [ ] TXXX UX consistency and accessibility review across completed stories
...
- Include explicit UX validation and performance verification tasks where the story changes behavior
- Record any non-trivial implementation tradeoff in the plan before or during execution
