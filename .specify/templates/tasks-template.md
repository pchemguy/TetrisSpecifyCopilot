...
**Tests**: Automated test tasks are REQUIRED for each user story and every
behavior-changing fix. If a change genuinely does not need automated coverage,
add an explicit task to document the approved justification.
...
- [ ] T004 [P] Set up baseline performance measurement or profiling approach
...
> add performance verification tasks whenever a budget applies**
...
- [ ] T013 [P] [US1] Performance test or benchmark for [critical path] in tests/performance/test_[name].py
...
- [ ] T018 [US1] Validate loading, empty, success, and failure states for the user flow
- [ ] T019 [US1] Add validation, error handling, and logging for user story 1 operations
...
- [ ] T022 [P] [US2] Performance test or benchmark for [critical path] in tests/performance/test_[name].py
...
- [ ] T026 [US2] Validate UX consistency and integration with User Story 1 components (if needed)
...
- [ ] T029 [P] [US3] Performance test or benchmark for [critical path] in tests/performance/test_[name].py
...
- [ ] TXXX Performance budget validation across all stories
- [ ] TXXX [P] Additional unit and integration tests in tests/
- [ ] TXXX [P] UX consistency and accessibility audit
...
Task: "Performance test or benchmark for [critical path] in tests/performance/test_[name].py"
...
- Each user story should be independently completable, testable, and checked for UX consistency
- Verify tests fail before implementing and validate performance budgets where applicable
